...
pub const RAW_BUFFER_SIZE: u64 = BUFFER_SIZE - AES_OVERHEAD; // IO buffer size
pub const BUFFERS_PER_SLICE: u64 = (SLICE_SIZE + BUFFER_SIZE - 1) / BUFFER_SIZE; // Number of buffers per slice (rounded up)
